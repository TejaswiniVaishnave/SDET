...
public class ScheduleMeeting {
    ...
    public void ScheduleMeeting() throws InterruptedException {
    	...
    	driver.findElement(By.id("name")).sendKeys("Meeting to Discuss on Requirements");
    	driver.findElement(By.id("date_start_date")).sendKeys("12/15/2020");
    	driver.findElement(By.id("date_start_hours")).sendKeys("07");
    	driver.findElement(By.id("date_start_minutes")).sendKeys("25");
    	driver.findElement(By.id("date_end_date")).sendKeys("12/15/2020");
    	driver.findElement(By.id("date_end_hours")).sendKeys("08");
    	driver.findElement(By.id("date_end_minutes")).sendKeys("25");
    ...
    public void ValidateMeeting()  {    	
    	...
    	if(driver.findElement(By.linkText("Meeting to Discuss Business")).isDisplayed())
    	{
    		...
    		System.out.println("The Meeting has scheduled successfully"); 
    	}

    	else
    	{
    		System.out.println("The meeting could not able to scheduled");
