...
public class CreateJobVacancy {
    ...
    public void AddVacancies() {
    	...
    	driver.findElement(By.id("addJobVacancy_name")).sendKeys("Sample Vacancy");

    	driver.findElement(By.id("addJobVacancy_hiringManager")).sendKeys("Hello Tester");
    ...
    public void VerifyVacancies() {
    	...
    	dropdown2.selectByVisibleText("Sample Vacancy");

    	WebElement Manager=driver.findElement(By.id("vacancySearch_hiringManager"));

    	Select dropdown3 = new Select(Manager);

    	dropdown3.selectByVisibleText("Hello Tester");

    	driver.findElement(By.id("btnSrch")).click();    	    	

    	String JobTitle1 = driver.findElement(By.linkText("Sample Vacancy")).getText();

    	Assert.assertEquals(JobTitle1, "Sample Vacancy");  	    
