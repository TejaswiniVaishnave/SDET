...
public class AddNewCandidate {
    ...
    File file = new File("src/test/resources/CV.docx");
    ...
    public void CandidateInformation() {
    	...
    	driver.findElement(By.id("addCandidate_firstName")).sendKeys("Vaishnavi");

    	driver.findElement(By.id("addCandidate_lastName")).sendKeys("Tejaswini");

    	driver.findElement(By.id("addCandidate_email")).sendKeys("Sample231@mail.com");
    ...
    public void Verfication() {	
    	...
    	Name.sendKeys("Vaishnavi Tejaswini");

    	driver.findElement(By.id("btnSrch")).click();    	    	

    	String JobTitle1 = driver.findElement(By.linkText("Vaishnavi Tejaswini")).getText();

    	Assert.assertEquals(JobTitle1, "Vaishnavi Tejaswini"); 
