create database sdet4_tejaswini;
use sdet4_tejaswini;
...
VALUES (104, 'Sam', 'Hyderabad', 60000);
...
SELECT * FROM salesman WHERE city='Bangalore';


SELECT salesman_id, commission FROM salesman WHERE name='Sam';

ALTER TABLE salesman ADD grade int;

UPDATE salesman SET grade=100 WHERE salesman_id='101';

UPDATE salesman SET grade=200 WHERE salesman_id='5007';

UPDATE salesman SET grade=300 WHERE salesman_id='5001';
